							...
							<table class="hovertable">
								<tr>
									...
									<tr onMouseOver="this.style.backgroundColor='#fdf5e6';"
										...
										<td><a href="searchBookByTitle?title=<s:property value="book.Title" />&authorid=<s:property value="book.AuthorID" />"></a><s:property value="book.Title" /></td>
										...
										<td><a href="deleteBookByid?bookid=<s:property value="book.ISBN" />&authorid=<s:property value="book.AuthorID" />&title=<s:property value="book.Title" />">Delete</a>
										    <a href="updateBookByid?bookid=<s:property value="book.ISBN" />&authorid=<s:property value="book.AuthorID" />&title=<s:property value="book.Title" />">Update</a>
										</td>
								</tr>

							</table>
						</form>
						<a href="authorSelect?authorName=<s:property value="author.Name"/>">Return</a>
			</div>
