		...
		<!-- Header -->
			<div id="header">
				...
				<form class="form" action="update" method="post">
				 ...
				 <input type="hidden" name=authorid value="<s:property value="book.AuthorID" />">
			     <input type="hidden" name=bookid value="<s:property value="book.ISBN" />">
				 <div class="row collapse-at-2">
							<div class="6u">
								<input type="text" name="authorName" value="<s:property value="author.Name" />" />
							</div>
							<div class="6u">
								<input type="text" name="publisher" value="<s:property value="book.Publisher" />" />
							</div>
							<div class="6u">
								<input type="text" name="publishdate" value="<s:property value="book.PublishDate" />" />
							</div>
							<div class="6u">
								<input type="text" name="price" value="<s:property value="book.Price" />" />
							</div>
				</div>
				<input type="submit" value="OK" />
				</form>
				<!--<a href="searchBookByTitle?title=<s:property value="book.Title" />&authorid=<s:property value="book.AuthorID" />">Return</a>  -->
			</div>
